...
class Commande {
    ...
    public function createCommande($nom, $prenom, $adresse, $email, $telephone, $livraison, $reference,$prix_total) {
        try {
            $stmt = $this->conn->prepare(
                "INSERT INTO commandes (nom, prenom, adresse, email, telephone, livraison, reference,prix_total) 
    ...
    public function updateCommande($id, $nom, $prenom, $adresse, $email, $telephone, $livraison, $reference,$prix_total) {
        try {
            $stmt = $this->conn->prepare(
                "UPDATE commandes 
                SET nom = :nom, prenom = :prenom, adresse = :adresse, email = :email, 
                    telephone = :telephone, livraison = :livraison, reference = :reference , prix_total=:prix_total
                WHERE num_c = :id"
            );
