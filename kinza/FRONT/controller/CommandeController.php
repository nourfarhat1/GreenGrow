...
require_once 'C:\xampp\htdocs\Kinza\FRONT\model\CommandeModel.php';
...
class CommandeController {
    ...
    public function getBestSeller($conn) {
        try {
            ...
            echo "Erreur lors de la récupération du produit best-seller : " . $e->getMessage();
            return null;
        }
    }
