        ...
        if (!empty($users)): 
             ...
             foreach ($users as $user): ?>
                <tr>
                    ...
                    <td>
                    <form action="/BACK/index.php?action=ChangerType" method="post">
                        <input type="hidden" name="username" value="<?= htmlspecialchars($user['Username']) ?>">
                        <select name="user_type">
                            <option value="User">User</option>
                            <option value="Expert">Expert</option>
                        </select>
                        <button type="submit" onclick="return confirm('etes vous sur de vouloir changer les droits de cet utilisateur?');">Changer</button>
                    </form>
                </td>
            </tr>
                </tr>
