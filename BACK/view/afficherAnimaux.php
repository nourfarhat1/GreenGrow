                    ...
                    <tr>
                        ...
                        <td>
                            <?php if (!empty($categorie['image'])): ?>
                                <img src="../view/task2/template/uploads/ htmlspecialchars($categorie['image']) ?>" alt="<?= htmlspecialchars($categorie['type']) ?>" style="max-width: 100px; height: auto; border-radius: 5px;">
                            <?php else: ?>
                                Aucune image
                            <?php endif; ?>
                        </td>
