...
class Animal {
    ...
    public function updateAnimal($nom_a, $age, $age_type, $sexe, $symptomes, $quantite_n, $commentaire, $original_nom_a) {
        // Mettre à jour l'animal avec le nom de l'animal original comme condition
        $query = "UPDATE animaux
                  SET nom_a = :nom_a, age = :age, age_type = :age_type, sexe = :sexe, symptomes = :symptomes, quantite_n = :quantite_n, commentaire = :commentaire
